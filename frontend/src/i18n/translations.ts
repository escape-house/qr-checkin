const translations = {
    ...
    overviewErrorLoading: {
        de: "Fehler beim Laden der Slots.",
        en: "Error loading slots.",
    },
    overviewNoSlots: {
        de: "Keine aktiven Slots.",
        en: "No active slots.",
    },
    overviewFooterTerms: {
        de: "AGB",
    ...
    overviewFooterImprint: {
        de: "Impressum",
        en: "Imprint",
    },
    overviewRoomNotListed: {
        de: "Raum nicht dabei?",
        en: "Room not listed?",
    },
    ...
    roomsErrorLoading: {
        de: "Fehler beim Laden der Räume.",
        en: "Error loading rooms.",
    },
    roomsNoRooms: {
        de: "Keine Räume heute.",
        en: "No rooms today.",
    },

    // ── Check-in / success ─────────────────────────────────────
    checkinErrorLoading: {
        de: "Fehler beim Laden des Slots.",
        en: "Error loading slot.",
    },
    checkinSuccessTitle: {
        de: "Erfolgreich eingecheckt!",
    ...
    formError: {
        de: "Check-in fehlgeschlagen. Bitte versuche es erneut.",
    ...
    houseRulesTeamProtectionTitle: {
        de: "Schutz unseres Teams",
    ...
    houseRulesPersonalItemsTitle: {
        de: "Persönliche Gegenstände & elektronische Geräte",
