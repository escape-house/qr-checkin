...
export function SlotQrModal({url, label, onClose}: Props) {
    ...
    return (
        ...
        >
            <div className="bg-surface border border-border rounded-[--radius-lg] p-6 flex flex-col items-center gap-4 shadow-xl">
                <p className="text-sm font-semibold text-text-secondary uppercase tracking-widest">{label}</p>
                <div className="p-4 bg-white rounded-[--radius-md]">
